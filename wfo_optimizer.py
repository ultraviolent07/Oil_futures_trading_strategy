...
T_train_grid = [0.10, 0.15, 0.20]
VIX_train_grid = [20.0, 25.0, 30.0]
TP_train_grid = [1.5, 2.0]
LEVERAGE = 3.0
...
for i in range(4, len(years)):
    ...
    for t_val in T_train_grid:
        for vix_thresh in VIX_train_grid:
            for tp_atr in TP_train_grid:
                # 1. Filtered Momentum
...
print("\n=== FINAL UNIFIED TRUE WFO REGIME OOS STATS ===")
print(stats)
